    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        ...
        <p className="text-gray-600 mt-1">
          Welcome to your AgriTech AI dashboard
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="col-span-1 md:col-span-2 lg:col-span-4">
          <div className="bg-white rounded-lg p-4 shadow-md h-[500px]">
            <ChatContainer /> {/* ✅ Full chat (history + input + replies) */}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
              <p className="text-gray-500">
                Chart placeholder - Crop yield data visualization
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
              <p className="text-gray-500">
                Chart placeholder - Weather forecast visualization
              </p>
            </div>
          </div>
        </div>
